...
class DemandaTable extends Table {
  ...
  TextColumn get tipo => text().withLength(max: 50)(); // 'saude', 'educacao', 'habitacao', 'ambiente', 'interna'
  ...
  TextColumn get dadosEspecificos => text().nullable()(); // JSON string para dados específicos de cada tipo
