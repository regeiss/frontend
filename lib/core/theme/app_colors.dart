...
class AppColors {
  ...
  static Color get successBackgroundColor => successColor.withOpacity(0.1);
  static Color get warningBackgroundColor => warningColor.withOpacity(0.1);
  static Color get errorBackgroundColor => errorColor.withOpacity(0.1);
  static Color get infoBackgroundColor => infoColor.withOpacity(0.1);
